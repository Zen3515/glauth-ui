...
When you create a new user you have the option to send an invite link per mail. The Active checkbox controls whether the account is enabled immediately; leave it unchecked if the account should stay disabled until the user creates their password.
