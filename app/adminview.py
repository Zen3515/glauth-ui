...
class UserView(MyModelView):
    ...
    form_extra_fields = {
        ...
        'send_invite_link': BooleanField(
            'Send Invite Link',
            description=('Email a link for the user to set their password. '
                         'The Active checkbox controls whether the account is enabled immediately.')
        ),
    ...
    def on_model_change(self, form, model, is_created):
        ...
        if is_created:
            send_invite_link = form.send_invite_link.data
            if send_invite_link and ((not form.mail.data) or form.mail.data == '' ):
